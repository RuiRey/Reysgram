                ...
                <div className="forminmyweb">
                    ...
                    <form className="form-horizontal">
                        ...
                        <div className="form-group">
                            ...
                            <input onChange={handleChange} value={this.state.username} type="text" name="username" className="form-control" id="Username" required />
                            </div>
                        </div>
                        ...
                        <div className="form-group"> 
                            ...
                            <div className="col-sm-10">
                            <input onChange={handleChange} value={this.state.phoneNumber || ''} type="number" name="phoneNumber" className="form-control" id="phoneNumber" required />
                            </div>
                        </div>
                        ...
                        <div className="col-sm-10">
                          <select onChange={handleChange} value={this.state.gender || ''} name="gender" className="form-control" id="gender" required >
                            <option></option>
                            <option>Male</option>
